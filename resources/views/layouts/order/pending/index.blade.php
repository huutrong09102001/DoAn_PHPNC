			...
			<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						...
						<li class="active">Đơn yêu cầu hủy</li>
					</ul><!-- .breadcrumb -->
				...
				<div class="page-content">
					...
					<div class="row-fluid">
						<div class="span12">
							...
							<div class="row-fluid">
								<h3 class="header smaller lighter blue">Danh sách đơn yêu cầu hủy</h3>
									...
									<tbody>
										...
										<tr>
											...
											<td>
												...
												<form method="post" action="{{route('pendingOrder.update' ,$model->id)}}">
													@csrf
													@method('PUT')
														<button type="submit"><b>✅ Xác nhận</b></button>
													</form>										
													
													<form method="post" action="{{route('pendingOrder.refuse',[$model->id])}}">
													@csrf
													@method('PUT')
														<button type="submit"><b class="">❌ Từ chối</b></button>
													</form>
												</div>
