			...
			<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						...
						<li class="active">Đơn chờ xác nhận</li>
					</ul><!-- .breadcrumb -->
									...
									<tbody>
										...
										<tr>
											...
											<td>
												...
												<form method="post" action="{{route('confirmOrder.update' ,$model->id)}}">
													@csrf
													@method('PUT')
														<button type="submit"><b>✅ Xác nhận</b></button>
													</form>										
												
													<form method="post" action="{{route('confirmOrder.delete',[$model->id])}}">
													@csrf
													@method('DELETE')
														<button type="submit"><b>❌ Từ chối </b></button>
													</form>
												</div>
